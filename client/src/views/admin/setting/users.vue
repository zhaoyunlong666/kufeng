    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="4">
          ...
          <el-input ref="phone" v-model="phone" type="text" placeholder="请输入用户手机号" autocomplate="off" @input="changeInput" @change="getuserlist" @keyup.enter.native="getuserlist">
      ...
      <el-table key="userlist" :data="userlist" border stripe>
       ...
       <el-table-column prop="u_username" label="账户" />
        <el-table-column prop="u_name" label="姓名" />
        <el-table-column prop="u_tel" label="手机号" />
        
        <el-table-column prop="u_dept" label="部门" />
        <el-table-column prop="u_role_id" label="职务" />
        <el-table-column prop="u_sex" label="性别" />
        
        <el-table-column prop="u_address" label="家庭住址" />
        
        <!-- <el-table-column prop="u_openid" label="小程序ID" /> -->
        <el-table-column prop="u_state" label="管理状态" />
        
        <el-table-column prop="u_Job_description" label="职责描述" />
        <el-table-column prop="u_group_id" label="权限组" />
        ...
        <el-table-column label="操作" width='250'>
          ...
          @click="handleDelete(scope.$index, scope.row)">删除</el-button> -->
            ...
            <!--设置按钮-->
            <el-tooltip effect="dark" content="管理授权" placement="top" :enterable="false">
              <el-button type="warning" icon="el-icon-setting" size="mini" >授权</el-button>
            </el-tooltip>

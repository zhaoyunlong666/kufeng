<template>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="5">
          ...
          <el-input ref="phone" v-model="phone" type="text" placeholder="输入标题" autocomplate="off" @input="changeInput" @change="getuserlist" @keyup.enter.native="getuserlist">
  ...
  <!-- </el-form-item> -->
      ...
      <el-table key="userlist" :data="userlist" border stripe>
        ...
        <el-table-column prop="Usertype_id" :formatter="UsertypeFormat" label="消息类型">

    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          ...
          <el-input ref="phone" v-model="phone" type="text" placeholder="请输入考场名称" autocomplate="off" @input="changeInput" @change="getuserlist" @keyup.enter.native="getuserlist">
            <el-button slot="append" icon="el-icon-search" @click="getuserlist" />
          </el-input>

        </el-col>
        <el-col :span="4">
          <el-button type="primary">添加考场</el-button>
        </el-col>
      </el-row>
      <br>
      <!--用户 列表区域-->

    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          ...
          <el-input ref="phone" v-model="phone" type="text" placeholder="输入课程名称" autocomplate="off" @input="changeInput" @change="getuserlist" @keyup.enter.native="getuserlist">
      ...
      <el-table key="userlist" :data="userlist" border stripe>
        ...
        <el-table-column prop="Usertype_id" :formatter="UsertypeFormat" label="课程类型">
        ...
        <el-table-column prop="name" label="课程题" />
        <el-table-column prop="money" label="课程价格" />

    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          ...
          <el-input ref="phone" v-model="phone" type="text" placeholder="学员/教练 手机号" autocomplate="off" @input="changeInput" @change="getuserlist" @keyup.enter.native="getuserlist">
      ...
      <el-table key="userlist" :data="userlist" border stripe>
          <!-- <el-table-column prop="nickname" label="学员手机号" /> -->
       ...
       <!-- <el-table-column prop="Usertype_id" :formatter="UsertypeFormat" label="账号类型">
        ...
        <el-table-column prop="phone" label="预约手机号" />
        <el-table-column prop="nickname" label="预约姓名" />
        <el-table-column prop="teacher" label="预约教练" />
        <!-- <el-table-column prop="kecheng_type" label="所学学段" />
        <el-table-column prop="money" label="账户余额" /> -->
        <el-table-column prop="reg_time" label="预约时间" />
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <!--修改按钮-->
            <el-tooltip effect="dark" content="修改预约" placement="top" :enterable="false">
...
<br/><br/>
 <el-time-select
  ...
  placeholder="结束时间">
            ...
            <!--删除按钮-->
            <el-tooltip effect="dark" content="删除时间段" placement="top" :enterable="false">

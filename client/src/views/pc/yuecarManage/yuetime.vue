    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          ...
          <!-- <el-input ref="phone" v-model="phone" type="text" placeholder="学员手机号" autocomplate="off" @input="changeInput" @change="getuserlist" @keyup.enter.native="getuserlist">
            <el-button slot="append" icon="el-icon-search" @click="getuserlist" />
          </el-input> -->

        </el-col>
        <el-col :span="4">
          <el-button type="primary">添加时间段</el-button>
        </el-col>
      </el-row>
      <br>
      <!--用户 列表区域-->
      <el-table key="userlist" :data="userlist" border stripe>
          <el-table-column prop="nickname" label="时间段" />

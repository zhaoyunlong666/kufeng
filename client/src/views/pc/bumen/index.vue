    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          ...
          <el-input ref="phone" v-model="phone" type="text" placeholder="部门名称" autocomplate="off" @input="changeInput" @change="getuserlist" @keyup.enter.native="getuserlist">
            <el-button slot="append" icon="el-icon-search" @click="getuserlist" />
          </el-input>

        </el-col>
        <el-col :span="4">
          <el-button type="primary" @click="handaddnews()">添加部门</el-button>
           <el-dialog
              title="添加部门"
